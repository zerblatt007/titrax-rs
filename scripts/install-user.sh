...
install -m 755 "${SOURCE_BIN}" "${USER_BIN_DIR}/titrax-rs"
install -m 644 "${ROOT_DIR}/share/icons/hicolor/64x64/apps/titrax-rs.png" "${USER_ICON_DIR}/titrax-rs.png"
cat >"${USER_DESKTOP_DIR}/titrax-rs.desktop" <<EOF
[Desktop Entry]
Type=Application
Name=TimeTracker (titrax-rs)
Comment=Track time on projects
Exec=${USER_BIN_DIR}/titrax-rs
Icon=titrax-rs
Terminal=false
...
echo "Installed titrax-rs for the current user:"
echo "  binary:  ${USER_BIN_DIR}/titrax-rs"
echo "  icon:    ${USER_ICON_DIR}/titrax-rs.png"
echo "  desktop: ${USER_DESKTOP_DIR}/titrax-rs.desktop"
